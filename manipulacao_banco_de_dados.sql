...
insert into funcionarios value (null, 'Ricardo Sousa', '111.222.333-44', '1992-05-12', 'Rua Harmonia 157, São Paulo', '11987651234', 'ricardo.sousa@email.com', 'Chefe de Cozinha', 6000.00, '2019-03-15');

insert into funcionarios (nome, cpf, data_nascimento, endereco, telefone, email, cargo, salario, data_admissao) 
                   value ('Lívia Castro', '222.333.444-55', '1989-11-25', 'Av. Rebouças 1234, São Paulo', '11987653421', 'livia.castro@email.com', 'Subgerente', 5500.00, '2019-06-20'), 
...
insert into clientes value (null, 'Lucas Silva', '123.456.789-01', '1990-01-15', 'Av. Brigadeiro Faria Lima, 1571, São Paulo', '11987651234', 'lucas.silva@email.com', '2023-01-12');

insert into clientes (nome, cpf, data_nascimento, endereco, telefone, email, data_cadastro) 
               value ('Ana Paula', '234.567.890-12', '1985-03-22', 'Rua Oscar Freire, 1290, São Paulo', '11987652345', 'ana.paula@email.com', '2023-01-12'),
                     ...
                     ('Fábio Lopes', '998.890.123-45', '1989-08-12', 'Av. das NaçÃµes Unidas, 1889, São Paulo', '11987675678', 'fabio.lopes@email.com', '2023-01-12'),
...
insert into produtos (nome, descricao, preco, categoria)
               value ('Feijoada', 'Feijoada completa com arroz, farofa, couve e laranja.', 29.90, 'Prato Principal'),
                     ...
                     ('Mousse de Maracujá', 'Sobremesa leve e refrescante Ã  base de maracujá.', 12.00, 'Sobremesa'),
...
insert into info_produtos (id_produto, ingredientes, fornecedor) 
                    value (1, 'Feijão preto, carne seca, costelinha, linguiça, arroz, farinha, couve, laranja', 'Distribuidora Central'),
...
insert into pedidos (id_cliente, id_funcionario, id_produto, quantidade, data_pedido, status)
              value (1, 4, 1, 2, '2024-07-01', 'Concluído'),
